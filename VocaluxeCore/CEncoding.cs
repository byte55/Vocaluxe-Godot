...
namespace VocaluxeCore
{
    public static class CEncoding
    {
        static CEncoding()
        {
            // Legacy code pages (CP1250/CP1252) are not built into modern .NET — register them once
            // so UltraStar files declaring #ENCODING:CP1250/CP1252 keep loading correctly.
