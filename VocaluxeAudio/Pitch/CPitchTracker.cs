...
namespace VocaluxeAudio.Pitch
{
    ...
    /// </summary>
    public abstract class CPitchTracker : IDisposable
    {
        //Default number of half tones (1 octave)
        protected const int NumHalfTonesDef = 12;

        /// <summary>
        ///     Name of the native pitch tracker library. Resolves to PitchTracker.dll on Windows and
        ///     libPitchTracker.so on Linux/macOS via the default DllImport probing.
        /// </summary>
        internal const string NativeLib = "PitchTracker";
