...
namespace VocaluxeAudio.Record
{
    ...
    ///     Holds one capture buffer per player and routes interleaved multi-channel device data
    ///     to the right players via CRecordDevice.PlayerChannel.
    /// </summary>
    public abstract class CRecordBase
    {
